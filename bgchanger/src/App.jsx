   ...
   style={{backgroundColor : color}}>
    ...
    justify-center bottom-12 inset-x-0 px-2">
      ...
      px-3 py-2 rounded-3xl ">
        ...
        className="outline-none px-4 py-1 first-letter:rounded-full text-white shadow-lg"
        style={{backgroundColor :"red"}}>Red</button>
         <button
        onClick={()=>setColor("green")}
        className="outline-none px-4 py-1 first-letter:rounded-full text-white shadow-lg"
        style={{backgroundColor :"green"}}>Greened</button>
         <button
        ...
        className="outline-none px-4 py-1 first-letter:rounded-full text-white shadow-lg"
        style={{backgroundColor :"violet"}}>Violte</button>
         <button
